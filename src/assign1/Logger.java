...
/*
    assign1.Logger class which handles counting of packages. Supports use by multiple threads.
 */
public class Logger {
    ...
    public String toString() {
        return "assign1.Logger{" + "sent=" + totalSent + ", received=" + totalReceived + ", remaining="+remaining + '}';
